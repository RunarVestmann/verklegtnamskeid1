class State:
    ...
    __employee_and_airplane_states = (__NOT_SCHEDULED_FOR_FLIGHT, __WAITING_FOR_FLIGHT_FROM_ICELAND, __IN_FLIGHT_FROM_ICELAND,\
        __LANDED_ABROAD, __IN_FLIGHT_TO_ICELAND,)
